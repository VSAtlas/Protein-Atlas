...
class TargetEvaluation:
    ...
    z_selected: Optional[Any] = None

    @property
    def selected_scores(self) -> Optional[Any]:
        """Backward-compatible alias; canonical per-ligand payload is z_selected."""
        return self.z_selected
