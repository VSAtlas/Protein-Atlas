...
Outputs:
- <OVERALL_DIR>/analysis/dud_eval/out/<PDB_ID>/
    - metrics.tsv
    - ef_curve.png, roc.png, pr.png, score_hist.png
- <OVERALL_DIR>/analysis/dud_eval/out/summary.tsv (per-target table)
- <OVERALL_DIR>/analysis/dud_eval/out/summary_macro.tsv (macro average over targets)
...
def main():
    ...
    if cfg and "OVERALL_DIR" in cfg:
        ...
        analysis_root = Path(cfg["OVERALL_DIR"]) / "analysis" / "dud_eval" / "out"
