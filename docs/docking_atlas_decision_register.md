...
- Ligand stereochemistry evidence may be audited from an explicitly declared SDF or CSV
  molecular graph and bound to exact source-record and prepared-artifact hashes.
  The audit records specified, potential-but-unassigned, and unknown elements; it
  never invents assignments or treats PDBQT content as stereochemical authority.
  An unresolved audit observation is evidence, not an automatic invalidity or
...
| Ligand stereochemistry policy | A versioned, hash-bound SDF/CSV audit can record source-defined and potential-but-unassigned stereo without modifying structures. Prepared PDBQT hashes bind artifacts but do not establish stereochemical truth. Unspecified/unknown results remain evidence-pending and do not automatically invalidate or qualify a pair. | Approve authoritative source priority; treatment of racemates/mixtures, labile or non-isolable potential stereo, and genuinely unspecified centers; and the consequences for docking ranks, pose validity, and native-redock qualification. |
