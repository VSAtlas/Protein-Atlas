...
- **Hint:** Quarantine; consider pre-sanitize with RDKit, fix aromaticity, add hydrogens earlier.
  - **File:** `/stor/home/mpg2352/atlas/code/protein_automation/logs/bench_20251010_174111.log`
    - `[17:42:39] Explicit valence for atom # 10 O, 3, is greater than permitted`
    - `[17:42:56] Explicit valence for atom # 10 O, 3, is greater than permitted`
    - `[17:43:00] Explicit valence for atom # 7 O, 3, is greater than permitted`
...
- **Hint:** Conversion partial; capture stderr, retry fallback, then quarantine if persistent.
  - **File:** `/stor/home/mpg2352/atlas/code/protein_automation/logs/bench_20251010_174111.log`
    - `WARNING: 72 atoms of 79 in CDL_R605.sanitized.sanitized.mol2  were not written`
...
- **Hint:** Run Reduce/OpenBabel addH; if Reduce already ran, try -nohyd branch then addH fallback.
  - **File:** `/stor/home/mpg2352/atlas/code/protein_automation/logs/bench_20251010_174111.log`
    - `[17:43:06] /stor/home/mpg2352/atlas/code/protein_automation/processed_pdbs/6ADQ/ligands_raw/CDL_R605.sanitized.sanitized.pdb: Warning - no explicit hydrogens in mol2 file but needed for formal charge estimation.`
- **Paths:**
