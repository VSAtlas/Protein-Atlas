...
- **Hint:** Quarantine; consider pre-sanitize with RDKit, fix aromaticity, add hydrogens earlier.
  - **File:** `/stor/home/mpg2352/atlas/code/protein_automation/logs/bench_20251011_161130.log`
    - `[16:13:45] Explicit valence for atom # 10 O, 3, is greater than permitted`
    - `[16:13:49] Explicit valence for atom # 10 O, 3, is greater than permitted`
    - `[16:13:58] Explicit valence for atom # 10 O, 3, is greater than permitted`
- **Step:** ligprep.sanitize

## 2. [HARD] ligprep.mgl_partial_write - 6ADQ - CDL_H201.sanitized.sanitized
...
- **Hint:** Conversion partial; capture stderr, retry fallback, then quarantine if persistent.
  - **File:** `/stor/home/mpg2352/atlas/code/protein_automation/logs/bench_20251011_161130.log`
    - `WARNING: 73 atoms of 82 in CDL_H201.sanitized.sanitized.mol2  were not written`
...
- **Paths:**
  ...
  - bench_logs: `/stor/home/mpg2352/atlas/code/protein_automation/logs/bench_20251011_161130.log`
...
- **Hint:** Run Reduce/OpenBabel addH; if Reduce already ran, try -nohyd branch then addH fallback.
  - **File:** `/stor/home/mpg2352/atlas/code/protein_automation/logs/bench_20251011_161130.log`
    - `[16:14:06] /stor/home/mpg2352/atlas/code/protein_automation/processed_pdbs/6ADQ/ligands_raw/CDL_H201.sanitized.sanitized.pdb: Warning - no explicit hydrogens in mol2 file but needed for formal charge estimation.`
- **Step:** ligprep.add_h
- **Paths:**
