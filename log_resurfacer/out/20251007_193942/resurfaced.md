...
- **Hint:** Quarantine; consider pre-sanitize with RDKit, fix aromaticity, add hydrogens earlier.
  - **File:** `/stor/home/mpg2352/atlas/code/protein_automation/logs/bench_20251007_193942.log`
    - `[RDKit] ERROR:[19:39:54] Explicit valence for atom # 18 He, 1, is greater than permitted`
    - `rdkit.Chem.rdchem.AtomValenceException: Explicit valence for atom # 18 He, 1, is greater than permitted`
    - `[RDKit] ERROR:[19:39:55] Explicit valence for atom # 18 He, 1, is greater than permitted`

## 2. [HARD] dock.no_score — 1T46 — STI_A3.pdbqt
- **Message:** No score for 1 ligand(s)
- **Count:** 1  |  **Recency:** 2025-10-07 19:40:01
- **Hint:** Check ligand_prep_status.tsv for this ligand; verify docking ran; inspect pocket center/grid logs.
  - **File:** `docked/1T46/protein.log`
    - `2025-10-07 19:40:01,454 - WARNING - No score for STI_A3.pdbqt`
...
- **Hint:** Check ligand_prep_status.tsv for this ligand; verify docking ran; inspect pocket center/grid logs.
  - **File:** `docked/1T46/protein.log`
    - `2025-10-07 19:40:01,457 - WARNING - No score for STI_A3.sanitized.pdbqt`
- **Joins:**
...
- **Hint:** Check ligand_prep_status.tsv for this ligand; verify docking ran; inspect pocket center/grid logs.
  - **File:** `docked/1T46/protein.log`
    - `2025-10-07 19:40:01,542 - WARNING - No score for rdk_0000010.pdbqt`
...
- **Hint:** Check ligand_prep_status.tsv for this ligand; verify docking ran; inspect pocket center/grid logs.
  - **File:** `docked/1T46/protein.log`
    - `2025-10-07 19:40:01,542 - WARNING - No score for rdk_0000043.pdbqt`
...
- **Hint:** Check ligand_prep_status.tsv for this ligand; verify docking ran; inspect pocket center/grid logs.
  - **File:** `docked/1T46/protein.log`
    - `2025-10-07 19:40:01,542 - WARNING - No score for rdk_0002911.pdbqt`
...
- **Hint:** Check ligand_prep_status.tsv for this ligand; verify docking ran; inspect pocket center/grid logs.
  - **File:** `docked/1T46/protein.log`
    - `2025-10-07 19:40:01,543 - WARNING - No score for rdk_0000067.pdbqt`
...
- **Hint:** Check ligand_prep_status.tsv for this ligand; verify docking ran; inspect pocket center/grid logs.
  - **File:** `docked/1T46/protein.log`
    - `2025-10-07 19:40:01,544 - WARNING - No score for rdk_0000076.pdbqt`
...
- **Hint:** Check ligand_prep_status.tsv for this ligand; verify docking ran; inspect pocket center/grid logs.
  - **File:** `docked/1T46/protein.log`
    - `2025-10-07 19:40:01,546 - WARNING - No score for rdk_0000119.pdbqt`
...
- **Hint:** Check ligand_prep_status.tsv for this ligand; verify docking ran; inspect pocket center/grid logs.
  - **File:** `docked/1T46/protein.log`
    - `2025-10-07 19:40:01,550 - WARNING - No score for rdk_0000123.pdbqt`
...
- **Hint:** Check ligand_prep_status.tsv for this ligand; verify docking ran; inspect pocket center/grid logs.
  - **File:** `docked/1T46/protein.log`
    - `2025-10-07 19:40:01,551 - WARNING - No score for rdk_0000160.pdbqt`
...
- **Hint:** Check ligand_prep_status.tsv for this ligand; verify docking ran; inspect pocket center/grid logs.
  - **File:** `docked/1T46/protein.log`
    - `2025-10-07 19:40:01,552 - WARNING - No score for rdk_0000125.pdbqt`
...
- **Hint:** Check ligand_prep_status.tsv for this ligand; verify docking ran; inspect pocket center/grid logs.
  - **File:** `/stor/home/mpg2352/atlas/code/protein_automation/logs/bench_20251007_193942.log`
    - `Docking (bench_pocket1_single):   0%|          | 0/9 [00:00<?, ?ligand/s][A2025-10-07 19:40:01,542 - WARNING - No score for rdk_0000010.pdbqt`
...
- **Hint:** Control selection failed or disabled; check ‘hint_count’ and control whitelist.
  - **File:** `docked/1T46/protein.log`
    - `2025-10-07 19:40:01,313 - INFO - [render-enqueue] 1T46 bench_pocket1_single: receptor=/stor/home/mpg2352/atlas/code/protein_automation/processed_pdbs/1T46_NOLIG/receptor/1T46_NOLIG_cleaned.pdb | orig=/stor/home/mpg2352/atlas/code/protein_automation/input_pdbs/1T46.pdb | ctrl=None | rdk=None`
...
- **Hint:** Why no valid poses? Correlate with ‘No score’/validation; ensure control selection produced a pose.
  - **File:** `docked/1T46/protein.log`
    - `2025-10-07 19:40:01,556 - INFO - [render-skip] 1T46 bench_pocket1_single: no ctrl/rdk pose paths → no screenshots will be generated.`
...
- **Hint:** No evaluated poses to guide recentering; widen first-pass or ensure at least one pose completes.
  - **File:** `docked/1T46/protein.log`
    - `2025-10-07 19:40:01,553 - INFO - Early recenter skipped: evaluated=0 < threshold.`
