...
- **Hint:** Quarantine; consider pre-sanitize with RDKit, fix aromaticity, add hydrogens earlier.
  - **File:** `/stor/home/mpg2352/atlas/code/protein_automation/logs/bench_20251011_170606.log`
    - `[17:07:29] Explicit valence for atom # 10 O, 3, is greater than permitted`
    - `[17:07:36] Explicit valence for atom # 10 O, 3, is greater than permitted`
    - `[17:07:38] Explicit valence for atom # 10 O, 3, is greater than permitted`
- **Step:** ligprep.sanitize

## 2. [HARD] ligprep.mgl_partial_write - 6ADQ - CDL_P201.sanitized.sanitized
...
- **Hint:** Conversion partial; capture stderr, retry fallback, then quarantine if persistent.
  - **File:** `/stor/home/mpg2352/atlas/code/protein_automation/logs/bench_20251011_170606.log`
    - `WARNING: 81 atoms of 91 in CDL_P201.sanitized.sanitized.mol2  were not written`
- **Step:** ligprep.write_mol2
- **Paths:**
  - pre_raw_pdb_sanitized: `/stor/home/mpg2352/atlas/code/protein_automation/processed_pdbs/6ADQ/ligands_raw/CDL_P201.sanitized.sanitized.pdb`
  - post_pdbqt: `/stor/home/mpg2352/atlas/code/protein_automation/prepped_ligands/6ADQ/CDL_P201.sanitized.pdbqt`
  ...
  - bench_logs: `/stor/home/mpg2352/atlas/code/protein_automation/logs/bench_20251011_170606.log`
...
- **Hint:** Run Reduce/OpenBabel addH; if Reduce already ran, try -nohyd branch then addH fallback.
  - **File:** `/stor/home/mpg2352/atlas/code/protein_automation/logs/bench_20251011_170606.log`
    - `[17:08:41] /stor/home/mpg2352/atlas/code/protein_automation/processed_pdbs/6ADQ/ligands_raw/9Y0_K201.sanitized.sanitized.pdb: Warning - no explicit hydrogens in mol2 file but needed for formal charge estimation.`
    - `[17:08:53] /stor/home/mpg2352/atlas/code/protein_automation/processed_pdbs/6ADQ/ligands_raw/CDL_P201.sanitized.sanitized.pdb: Warning - no explicit hydrogens in mol2 file but needed for formal charge estimation.`
- **Step:** ligprep.add_h
- **Paths:**
  ...
  - pre_raw_pdb_sanitized: `/stor/home/mpg2352/atlas/code/protein_automation/processed_pdbs/6ADQ/ligands_raw/CDL_H201.sanitized.sanitized.pdb`
  ...
  - pre_raw_pdb_sanitized: `/stor/home/mpg2352/atlas/code/protein_automation/processed_pdbs/6ADQ/ligands_raw/9Y0_K201.sanitized.sanitized.pdb`
  ...
  - post_pdbqt: `/stor/home/mpg2352/atlas/code/protein_automation/prepped_ligands/6ADQ/CDL_P201.pdbqt`
  ...
  - post_pdbqt: `/stor/home/mpg2352/atlas/code/protein_automation/prepped_ligands/6ADQ/9Y0_K201.pdbqt`
  - post_pdbqt: `/stor/home/mpg2352/atlas/code/protein_automation/prepped_ligands/6ADQ/CDL_H201.sanitized.pdbqt`
  ...
  - post_pdbqt: `/stor/home/mpg2352/atlas/code/protein_automation/prepped_ligands/6ADQ/9Y0_K201.sanitized.pdbqt`
