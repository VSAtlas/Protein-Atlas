...
EXCLUDE_HET_IDS: Set[str] = set()
EXCLUDE_HET_NAME_KEYWORDS: Set[str] = set()
PER_PDB_HINTS: Dict[str, dict] = {}
HARD_FDA_CONTROL_BY_PDB: Dict[str, str] = {}


def _init():
    global CHEMCOMP_ALIAS
    global EXCLUDE_HET_IDS
    global EXCLUDE_HET_NAME_KEYWORDS
    global PER_PDB_HINTS
    global HARD_FDA_CONTROL_BY_PDB
    ...
    EXCLUDE_HET_NAME_KEYWORDS = (
        set(map(str.upper, exclude_kw)) or _BUILTIN_EXCLUDE_HET_NAME_KEYWORDS
    )
