...
def test_heatmap_html_order_and_na_white(tmp_path: Path, monkeypatch) -> None:
    ...
    rows = [
        {"target_id": "T1", "ligand_display": "L1", "ligand_base": "L1", "t_selected": "6"},
        {"target_id": "T2", "ligand_display": "L1", "ligand_base": "L1", "t_selected": "1"},
        {"target_id": "T1", "ligand_display": "L2", "ligand_base": "L2", "t_selected": "5"},
        {"target_id": "T1", "ligand_display": "L3", "ligand_base": "L3", "t_selected": "4"},
        {"target_id": "T2", "ligand_display": "L3", "ligand_base": "L3", "t_selected": "2"},
    ]
...
def test_heatmap_html_config_palette_bins(tmp_path: Path, monkeypatch) -> None:
    ...
    rows = [
        {"target_id": "T1", "ligand_display": "L1", "ligand_base": "L1", "t_selected": "-10"},
        {"target_id": "T1", "ligand_display": "L2", "ligand_base": "L2", "t_selected": "5"},
    ]
    input_csv = data_dir / "heatmap_input.csv"
    _write_csv(input_csv, rows)
