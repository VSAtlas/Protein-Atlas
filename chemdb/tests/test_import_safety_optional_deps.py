...
def test_core_imports_do_not_require_optional_deps(monkeypatch):
    blocked = {"tensorflow", "pymol", "gtk", "gobject"}
...
def test_optional_deps_loaded_only_on_explicit_paths(monkeypatch):
    _purge_modules({"tensorflow", "pymol", "gtk", "gobject"})
    ...
    import cli.cap_driver_cli as cap_driver
    from tools import molprobity_coot
