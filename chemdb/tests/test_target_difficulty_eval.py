...
def test_evaluate_difficulty_for_target_maps_buckets(
    tmp_path: Path, monkeypatch, caplog, roc_auc: float, expected: str
) -> None:
    ...
    monkeypatch.setattr(
        dud_eval, "evaluate_target", _fake_evaluate_target, raising=True
    )
